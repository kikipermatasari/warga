          ...
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                ...
                <form role="form" action="/kartu-keluarga/cek" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
              <div class="row">
                  <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="number" class="form-control" name="nik" id="nik" autofocus="autofocus" placeholder="MASUKAN NIK" aria-label="Recipient's username" aria-describedby="button-addon2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="16">
